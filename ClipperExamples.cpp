...
================================================================================
*/
AVector ShapeRadiusMatching::FindTheClosestIntersection(ALine line, std::vector<AVector> shape) // from start
{
...
================================================================================
*/
AVector ShapeRadiusMatching::FindTheFarthestIntersection(ALine line, std::vector<std::vector<AVector>> boundaries)
{
